...
if __name__ == '__main__':
    ...
    name='BCNN_glcm_KT2b_0.5_luping'
    ...
    # 加载数据
    #Coal_train_1.txt
    traindataset = MyDataset('./split/KT2b_train.txt',train_tfm,True)
    testdataset = MyDataset1('./split/KT2b_test.txt',test_tfm,True)
    #batchesize20->10 numw4->9
    train_iter = DataLoader(dataset=traindataset, batch_size=10, shuffle=True, num_workers=20)
    test_iter = DataLoader(dataset=testdataset, batch_size=10, shuffle=False, num_workers=20)
    # 训练模型
